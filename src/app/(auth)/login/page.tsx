    ...
    <div className="flex-1 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full space-y-6 bg-zinc-900/60 p-8 rounded-2xl border border-zinc-800/80 shadow-2xl backdrop-blur-xl">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-white">Autenticação Segura</h2>
          <p className="text-xs text-zinc-400">
            Acesse seu painel com isolamento de dados e permissões ativas
          </p>
        </div>
        ...
        <form action={formAction} className="space-y-4">
          ...
          >
            <span>{isPending ? 'Validando...' : 'Entrar na Plataforma'}</span>
